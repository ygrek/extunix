(* OASIS_START *)
(* DO NOT EDIT (digest: 0fa22273a038a68b6a1bb82b389d0bd8) *)
...
let package_default =
  {
     ...
     lib_c =
       [
          ("extunix",
            "src/",
            ["src/config.h"; "src/endian_helper.h"; "src/common.h"])
       ];
     flags =
       [
...
let gen gen_all prod =
  ...
  ~deps:["src/extUnix.mlpp";"src/ppx_have.byte";"src/extUnixConfig.cmo"]
  ~prod
  (fun _ _ -> Cmd
