...
(* OASIS_START *)
(* DO NOT EDIT (digest: 28f91747767b1c17b7ede9487be25f1c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["ExtUnix"; "ExtUnixAll"; "ExtUnixSpecific"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_user_namespace.ml"
                   });
               Test
                 ({
                     cs_name = "main";
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_user_namespace"
                        ]
                   });
               Doc
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\169\213\230\"\145\192>\014h%\193A\135\239\014\145";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
