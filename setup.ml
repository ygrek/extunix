...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0b156b09cdee0a3c51d8ba4e5fe1f14c) *)
(*
...
# 21 "/home/ygrek/work/contrib/oasis/src/plugins/custom/CustomPlugin.ml"
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({cs_name = "extunix"; cs_data = PropList.Data.create (); },
                   {
               ...
               Flag
                 ({cs_name = "strict"; cs_data = PropList.Data.create (); },
                   {
          ...
          plugins = [("DevFiles", Some "0.1.0"); ("META", Some "0.1.0")];
